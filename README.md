...
![Live Demo](https://img.shields.io/badge/Live%20Demo-View%20Site-2563eb?style=for-the-badge)
...
▶ View the live project page  ·  Watch the dashboard demo video
---
Overview
...
Methodology
Data Acquisition — collect public historical market and corporate-event data
Data Preparation — clean, transform, and structure the data for analytical use
Data Modeling — build an analytical model supporting flexible filtering and calculations
Analytical Layer — develop DAX measures for performance, risk, and benchmark analysis
Visualization — design interactive Power BI views and custom Deneb/Vega-Lite visuals
...
![GitHub](https://img.shields.io/badge/GitHub-sotheangoun--lab-181717?style=flat-square&logo=github&logoColor=white)
License
This project is licensed under the MIT License. Market data sourced from Yahoo Finance is used for analytical and portfolio demonstration purposes only.
